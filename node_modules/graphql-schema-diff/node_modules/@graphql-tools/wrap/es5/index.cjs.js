...
var HoistField = /** @class */ (function () {
        ...
        this.transformer = new MapFields((_a = {},
            _a[typeName] = (_b = {},
                _b[newFieldName] = function (fieldNode) {
                    return wrapFieldNode(utils.renameFieldNode(fieldNode, oldFieldName), pathToField, alias, argLevels);
                },
                _b),
            _a), (_c = {},
    ...
    HoistField.prototype.transformSchema = function (schema) {
        ...
        var newTargetField = tslib.__assign(tslib.__assign({}, targetField), { resolve: delegate.defaultMergedResolver });
